...
@endphp
@if( in_array('create_email_format', $user_permisions ) )
                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <thead  class="text-primary">
                                    ...
                                    <th>Subject</th>
                                    <th>Content</th>
                                @if(in_array('update_email_format', $user_permisions ) || in_array('delete_email_format', $user_permisions ) )
                                    <th>Action</th>
                                @endif 
                                    </tr>
                                </thead>
